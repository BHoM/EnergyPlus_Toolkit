...
////{
////public class GlazedDoor:Interzone : BHoMObject
////{
...
////[Description("Name of Surface (Wall, usually) the Door is on (i.e., Base Surface)")]
////public virtual object-list BuildingSurfaceName { get; set; } = new object-list;
////[Description("Specify a surface name in an adjacent zone for known interior doors.")]
