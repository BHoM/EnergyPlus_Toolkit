...
////{
////public class CoolingTower:VariableSpeed : BHoMObject
////{
...
////[Description("Determines the coefficients and form of the equation for calculating")]
////public virtual choice ModelType { get; set; } = new choice;
////[Description("Name of the tower model coefficient object.")]
////public virtual object-list ModelCoefficientName { get; set; } = new object-list;
...
////[Description("Enter the fan motor electric input power at design (max) air flow through the tower")]
////public virtual real DesignFanPower { get; set; } = new real;
////[Description("FPR = a + b*AFR + c*AFR**2 + d*AFR**3")]
////public virtual object-list FanPowerRatioFunctionOfAirFlowRateRatioCurveName { get; set; } = new object-list;
...
////[Description("Enter the fraction of tower capacity in the free convection regime. This is the")]
////public virtual real FractionOfTowerCapacityInFreeConvectionRegime { get; set; } = new real;
