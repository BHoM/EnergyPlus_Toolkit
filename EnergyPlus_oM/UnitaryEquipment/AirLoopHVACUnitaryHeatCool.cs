...
////{
////public class AirLoopHVAC:UnitaryHeatCool : BHoMObject
////{
...
////[Description("No description available")]
////public virtual node UnitarySystemAirInletNodeName { get; set; } = new node;
////[Description("No description available")]
////public virtual node UnitarySystemAirOutletNodeName { get; set; } = new node;
...
////[Description("Only works with DX cooling coil types or")]
