...
////{
////public class LifeCycleCost:NonrecurringCost : BHoMObject
////{
////[Description("No description available")]
////public virtual alpha Name { get; set; } = new alpha;
////[Description("No description available")]
////public virtual choice Category { get; set; } = new choice;
////[Description("Enter the non-recurring cost value. For construction and other capital costs the value")]
