...
////{
////public class WaterHeater:HeatPump:PumpedCondenser : BHoMObject
////{
...
////[Description("Should match the field Source Outlet Node Name in the water heater tank object.")]
////public virtual node CondenserWaterInletNodeName { get; set; } = new node;
////[Description("Should match the field Source Inlet Node Name in water heater tank object.")]
////public virtual node CondenserWaterOutletNodeName { get; set; } = new node;
////[Description("Actual water flow rate through the heat pump's water coil (condenser).")]
////public virtual real CondenserWaterFlowRate { get; set; } = new real;
...
////[Description("Used to indicate height of control sensor for Tank Object Type = WaterHeater:Stratified")]
