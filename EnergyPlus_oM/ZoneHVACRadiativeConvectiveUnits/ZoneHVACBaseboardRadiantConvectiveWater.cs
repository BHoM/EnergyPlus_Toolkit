...
////{
////public class ZoneHVAC:Baseboard:RadiantConvective:Water : BHoMObject
////{
...
////[Description("Rated average water temperature is the average of the inlet and outlet water temperatures")]
////public virtual real RatedAverageWaterTemperature { get; set; } = new real;
////[Description("Standard is I=B=R Rating document where all baseboards are rated at either 0.063 kg/s (1 gpm)")]
////public virtual real RatedWaterMassFlowRate { get; set; } = new real;
