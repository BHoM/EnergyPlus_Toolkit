...
////{
////public class ChillerHeater:Absorption:DirectFired : BHoMObject
////{
...
////public virtual null FuelInputToCoolingOutputRatio { get; set; } = new null;
////[Description("The positive fraction that represents the ratio of the")]
////public virtual null FuelInputToHeatingOutputRatio { get; set; } = new null;
////[Description("The positive fraction that represents the ratio of the")]
