...
////{
////public class HVACTemplate:Zone:DualDuct : BHoMObject
////{
...
////public virtual object-list TemplateDualDuctSystemName { get; set; } = new object-list;
...
////[Description("This field is the Zone Minimum Air Flow Fraction specified as a fraction of the")]
...
////[Description("Plenum zone name. Cold supply plenum that serves only this zone.")]
////public virtual object-list ColdSupplyPlenumName { get; set; } = new object-list;
////[Description("Plenum zone name. Hot supply plenum that serves only this zone.")]
////public virtual object-list HotSupplyPlenumName { get; set; } = new object-list;
////[Description("Plenum zone name. Return plenum that serves only this zone.")]
