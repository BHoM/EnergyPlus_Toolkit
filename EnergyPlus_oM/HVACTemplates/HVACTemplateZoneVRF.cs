...
////{
////public class HVACTemplate:Zone:VRF : BHoMObject
////{
...
////public virtual object-list TemplateVRFSystemName { get; set; } = new object-list;
...
////public virtual real RatedTotalHeatingCapacitySizingRatio { get; set; } = new real;
...
////[Description("This flow rate is used when the terminal is not cooling and the previous mode was cooling.")]
...
////[Description("This flow rate is used when the terminal is not heating and the previous mode was heating.")]
////public virtual real NoHeatingSupplyAirFlowRate { get; set; } = new real;
////[Description("If this field is set to autosize it will be sized based on the outdoor air inputs below,")]
