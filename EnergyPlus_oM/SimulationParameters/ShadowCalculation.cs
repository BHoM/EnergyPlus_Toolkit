...
namespace BH.oM.EnergyPlus
{
    public class ShadowCalculation : BHoMObject, IEnergyPlusClass
    {
        ...
        [Order][Description("choose calculation method. note that TimestepFrequency is only needed for certain cases")]
        public virtual CalculationMethod CalculationMethod { get; set; } = CalculationMethod.AverageOverDaysInFrequency;
        [Order][Description("Frequency at which calculation will be made")]
        public virtual int CalculationFrequency { get; set; } = 20;
        [Order][Description("Number of allowable figures in shadow overlap calculations")]
        public virtual int MaximumFiguresInShadowOverlapCalculations { get; set; } = 15000;
        [Order][Description("Advanced Feature. Internal default is SutherlandHodgman")]
        public virtual PolygonClippingAlgorithm PolygonClippingAlgorithm { get; set; } = PolygonClippingAlgorithm.SutherlandHodgman;
        [Order][Description("Advanced Feature. Internal default is SimpleSkyDiffuseModeling")]
        ...
        [Order][Description("If ScheduledShading is chosen, the External Shading Fraction Schedule Name is required")]
        ...
        [Order][Description("If True is chosen, the calculated external shading fraction results will be saved to an external CSV file with surface names as the column headers.")]
        public virtual bool OutputExternalShadingCalculationResults { get; set; } = false;
        [Order][Description("If True, self-shading will be disabled from all exterior surfaces in a given Shading Zone Group to surfaces within")]
        public virtual bool DisableSelfShadingWithinShadingZoneGroups { get; set; } = false;
        [Order][Description("If True, self-shading will be disabled from all exterior surfaces in a given Shading Zone Group to all other zones in the model.")]
        public virtual bool DisableSelfShadingFromShadingZoneGroupsToOtherZones { get; set; } = false;
        [Order][Description("Specifies a group of zones which are controlled by the Disable Self-Shading fields.")]
