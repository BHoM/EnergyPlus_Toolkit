...
////{
////public class HeaderedPumps:VariableSpeed : BHoMObject
////{
...
////[Description("If the field is not autosized set to the flow rate to")]
////public virtual null TotalDesignFlowRate { get; set; } = new null;
////[Description("No description available")]
////public virtual integer NumberOfPumpsInBank { get; set; } = new integer;
////[Description("No description available")]
////public virtual choice FlowSequencingControlScheme { get; set; } = new choice;
////[Description("default head is 60 feet")]
////public virtual null DesignPumpHead { get; set; } = new null;
////[Description("If the field is not autosized set to the power consumed by the pump bank")]
...
////public virtual null MinimumFlowRateFraction { get; set; } = new null;
////[Description("No description available")]
