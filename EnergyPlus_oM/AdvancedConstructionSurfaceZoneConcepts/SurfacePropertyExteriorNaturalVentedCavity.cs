...
////{
////public class SurfaceProperty:ExteriorNaturalVentedCavity : BHoMObject
////{
...
////[Description("No description available")]
////public virtual real AreaFractionOfOpenings { get; set; } = new real;
////[Description("No description available")]
////public virtual real ThermalEmissivityOfExteriorBaffleMaterial { get; set; } = new real;
////[Description("No description available")]
////public virtual real SolarAbsorbtivityOfExteriorBaffle { get; set; } = new real;
////[Description("No description available")]
////public virtual real HeightScaleForBuoyancy-DrivenVentilation { get; set; } = new real;
////[Description("if corrugated, use average depth")]
////public virtual real EffectiveThicknessOfCavityBehindExteriorBaffle { get; set; } = new real;
////[Description("this parameter is used to help account for corrugations in the collector")]
////public virtual real RatioOfActualSurfaceAreaToProjectedSurfaceArea { get; set; } = new real;
////[Description("No description available")]
////public virtual choice RoughnessOfExteriorSurface { get; set; } = new choice;
////[Description("No description available")]
